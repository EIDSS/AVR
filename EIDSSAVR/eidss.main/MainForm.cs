...
namespace eidss.main
{
    public partial class MainForm : BvForm, IMainForm
    {
        ...
        public void RegisterActions()
        {
            ...
            //  string[] files = Directory.GetFiles((WinUtils.AppPath()), "eidss*.dll"); //string[] files = Directory.GetFiles((WinUtils.AppPath()), "eidss*.dll");    
            string[] files = new string[] { "eidss.avr.dll",
                "eidss.core.dll",
                "eidss.gis.common.dll",
                "eidss.gis.dll",
                //"eidss.skin.dll",
                //"eidss.winclient.dll",
                "eidss_admin.dll",
        ...
        public void RegisterDefaultActions()
        {
            ...
            bool bWithouFlags = IsLangMenuWithoutFlags;
              ...
              var xx = Properties.Resources.ResourceManager.GetString("MenuEnglish");
        ...
        private bool Login()
        {
            ...
            if (!ReloadMenu())
                return false;
            // Requirement change    Form should now show.      
            //  Visible = true;
        ...
        private void MainForm_Activated(object sender, EventArgs e)
        {
            ...
            //  Show AVR     
            //if ( MenuActionManager.Instance.AVR.Items.Count >  0    &&  avrUp  )    
            //{
            //        avrUp = false;
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            // Put a reference to this form on the ihstance 
            MenuActionManager.Instance.MainFormInstance = this;
